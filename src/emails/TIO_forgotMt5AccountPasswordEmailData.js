...
const templateData = {
  en: (params) => {
    ...
    const result = {
      ...
      subject: `Reset password for trading account ${params.account_number} (${timeNow})`,
      content: {
        title: `Dear ${params.full_name},`,
        body1: `Your request to reset your trading account password for account number <b>${params.account_number}</b> has been successful.`,
        body2: `Your new password is <b>${params.new_password}</b>`,
        body3: `Account Number: <b>${params.account_number}</b>`,
        body4: `Platform: <b>${params.platform}</b><br>Server: <b>${params.server}</b><br>`,
        body5: `If you didn't request a password change, please reply to this email so that we can investigate what happened <a href="mailto:${params.support_email}">${params.support_email}</a>`,
  ...
  ar: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `نجح طلبك لإعادة تعيين كلمة مرور حساب التداول الخاص بك لرقم الحساب <b>${params.account_number}</b>`,
        body2: `كلمة مرورك الجديدة هي <b>${params.new_password}</b>`,
        body3: `رقم الحساب: <b>${params.account_number}</b>`,
        body4: `نوع الحساب: <b>${params.platform}</b><br>السيرف: <b>${params.server}</b><br>`,
        body5: `إذا لم تطلب تغيير كلمة المرور، يرجى الرد على هذا البريد الإلكتروني حتى نتمكن من التحقيق مما حد <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `${params.company_name}<br><br>,مع أطيب تحياتنا،`,
      },
      footer: {
  ...
  cz: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `Vaše žádost o resetování hesla pro Váš účet <b>${params.account_number}</b> byla úspěšná.`,
        body2: `Nové heslo <b>${params.new_password}</b>`,
        body3: `Číslo účtu: <b>${params.account_number}</b>`,
        body4: `Plošina: <b>${params.platform}</b><br>Server: <b>${params.server}</b><br>`,
        body5: `Pokud jste nežádali o změnu hesla, prosím odpovězte na tento email, abychom mohli zajistit plnou bezpečnost Vašeho účtu <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `S pozdravem,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  de: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `Ihre Anforderung für das Zurücksetzen des Passwortes Ihres Handelskontos für Kontonummer <b>${params.account_number}</b> war erfolgreich.`,
        body2: `Ihr neues Passwort lautet <b>${params.new_password}</b>`,
        body3: `Kontonummer: <b>${params.account_number}</b>`,
        body4: `Platform: <b>${params.platform}</b><br>Server: <b>${params.server}</b><br>`,
        body5: `Wenn Sie keine Passwortänderung angefordert haben, antworten Sie auf diese E-Mail, damit wir untersuchen können, warum Sie diese E-Mail erhalten haben <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `Mit freundlichen Grüßen,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  es: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `Su solicitud para restablecer la contraseña de su cuenta de trading para la cuenta número <b>${params.account_number}</b> ha tenido éxito.`,
        body2: `Su nueva contraseña es <b>${params.new_password}</b>`,
        body3: `Número de cuenta: <b>${params.account_number}</b>`,
        body4: `Plataforma: <b>${params.platform}</b><br>Servidor: <b>${params.server}</b><br>`,
        body5: `Si no había solicitado un cambio de contraseña, responda a este correo electrónico para que podamos investigar lo ocurrido <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `Saludos cordiales,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  fr: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `Votre demande de réinitialisation du mot de passe de votre compte de trading pour le numéro de compte <b>${params.account_number}</b> a été acceptée.`,
        body2: `Votre nouveau mot de passe est <b>${params.new_password}</b>`,
        body3: `Numéro de compte: <b>${params.account_number}</b>`,
        body4: `Plateforme: <b>${params.platform}</b><br>Serveur: <b>${params.server}</b><br>`,
        body5: `Si vous n'avez pas demandé un changement de mot de passe, veuillez répondre à cet email afin que nous puissions enquêter sur ce qui s'est passé <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `Très cordialement,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  hi: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `अकाउंट संख्या <b>${params.account_number}</b> के लिए अपना ट्रेडिंग अकाउंट पासवर्ड रीसेट करने का आपका अनुरोध सफल रहा।`,
        body2: `आपका नया पासवर्ड <b>${params.new_password}</b>`,
        body3: `अकाउंट नंबर: <b>${params.account_number}</b>`,
        body4: `लेटफार्म: <b>${params.platform}</b><br>सर्वर: <b>${params.server}</b><br>`,
        body5: `यदि आपने पासवर्ड बदलने का अनुरोध नहीं किया, तो कृपया इस ईमेल का उत्तर दें जिससे हम जांच कर सकें कि क्या हुआ <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `सधन्यवाद,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  hu: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `Kérése a <b>${params.account_number}</b> számlaszámra vonatkozó kereskedési fiók jelszavának megváltoztatására sikeres volt.`,
        body2: `Az új jelszava <b>${params.new_password}</b>`,
        body3: `Számlaszám: <b>${params.account_number}</b>`,
        body4: `Platform: <b>${params.platform}</b><br>Szerver: <b>${params.server}</b><br>`,
        body5: `Ha nem Ön kért jelszó módosítást, akkor válaszoljon erre az e-mailre, hogy kivizsgálhassuk a történteket <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `Üdvözlettel,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  id: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `Permohonan Anda untuk mengatur ulang kata sandi akun trading Anda dengan nomor <b>${params.account_number}</b> berhasil.`,
        body2: `Kata sandi baru Anda <b>${params.new_password}</b>`,
        body3: `Számlaszám: <b>${params.account_number}</b>`,
        body4: `Platform: <b>${params.platform}</b><br>Szerver: <b>${params.server}</b><br>`,
        body5: `Jika Anda tidak merasa mengajukan perubahan kata sandi, harap balas email ini agar kami dapat menyelidikinya. Alamat email kami adalah <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `Hormat kami,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  ms: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `Permintaan anda untuk menetapkan semula kata laluan akaun dagangan anda untuk nombor akaun <b>${params.account_number}</b> telah berjaya.`,
        body2: `Kata laluan baru anda ialah <b>${params.new_password}</b>`,
        body3: `Nombor Akaun: <b>${params.account_number}</b>`,
        body4: `Platform: <b>${params.platform}</b><br>Pelayan: <b>${params.server}</b><br>`,
        body5: `Jika anda tidak membuat permintaan untuk mengubah kata laluan, sila balas e-mel ini supaya kami dapat menyiasat perkara yang berlaku <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `Salam mesra,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  nl: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `Uw verzoek tot het herstellen van het wachtwoord voor uw handelsaccounts voor accountnummer <b>${params.account_number}</b> is in goede orde verwerkt.`,
        body2: `Uw nieuwe wachtwoord is <b>${params.new_password}</b>`,
        body3: `Rekeningnummer: <b>${params.account_number}</b>`,
        body4: `Platform: <b>${params.platform}</b><br>Server: <b>${params.server}</b><br>`,
        body5: `Heeft u geen verzoek tot wijziging van uw wachtwoord ingediend, beantwoord dan deze e-mail, zodat wij kunnen uitzoeken wat er gebeurd is <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `Met vriendelijke groet,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  ph: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `Ang iyong kahilingan para i-reset ang password ng iyong account sa pangangalakal para sa numero ng account na <b>${params.account_number}</b> ay naging matagumpay.`,
        body2: `Ang iyong bagong password ay <b>${params.new_password}</b>`,
        body3: `Numero ng Account: <b>${params.account_number}</b>`,
        body4: `Platform: <b>${params.platform}</b><br>Server: <b>${params.server}</b><br>`,
        body5: `Kung hindi ka humiling na palitan ang password, mangyaring tumugon sa email na ito upang maibestigahan namin kung ano ang nangyari <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `Malugod na bumabati,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  pl: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `Twoja prośba o zresetowanie hasła do rachunku handlowego dla numeru rachunku <b>${params.account_number}</b> zakończyła się sukcesem.`,
        body2: `Twoje nowe hasło to <b>${params.new_password}</b>`,
        body3: `Numer rachunku: <b>${params.account_number}</b>`,
        body4: `Platformie: <b>${params.platform}</b><br>Serwer: <b>${params.server}</b><br>`,
        body5: `Jeśli nie poprosiłeś/aś o zmianę hasła, odpowiedz na tego e-maila, abyśmy mogli sprawdzić, co się stało <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `Uprzejme pozdrowienia,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  pt: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `O seu pedido de recuperação da palavra-passe da sua conta de negociação número <b>${params.account_number}</b> foi bem-sucedido.`,
        body2: `A sua nova palavra-passe é <b>${params.new_password}</b>`,
        body3: `Account Number: <b>${params.account_number}</b>`,
        body4: `Plataforma: <b>${params.platform}</b><br>Servidor: <b>${params.server}</b><br>`,
        body5: `Se não solicitou a alteração da palavra-passe, solicitamos que responda a este email para que possamos averiguar o que se passou <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `Melhores cumprimentos,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  cn: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `您成功申请了重设帐号 <b>${params.account_number}</b> 的交易帐户密码。`,
        body2: `Your new password is <b>${params.new_password}</b>`,
        body3: `账号: <b>${params.account_number}</b>`,
        body4: `的平台: <b>${params.platform}</b><br>服务器: <b>${params.server}</b><br>`,
        body5: `如果您没有申请更改密码，请回复此电子邮件至 <a href="mailto:${params.support_email}">${params.support_email}</a>，以便我们调查原因。`,
        closing: `谨致问候,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  sk: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `Ešne ste požiadali o resetovanie hesla k obchodnému účtu číslo <b>${params.account_number}</b>.`,
        body2: `Nové heslo je <b>${params.new_password}</b>`,
        body3: `Číslo účtu: <b>${params.account_number}</b>`,
        body4: `Platforma: <b>${params.platform}</b><br>Server: <b>${params.server}</b><br>`,
        body5: `Ak ste o zmenu hesla nepožiadali, odpovedzte na tento e-mail, aby sme zistili, čo sa stalo <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `S pozdravom,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  tc: (params) => {
    ...
    const result = {
      ...
      content: {
        title: `尊敬的 ${params.full_name},`,
        body1: `您成功申請了重設帳號 <b>${params.account_number}</b> 的交易帳戶密碼。`,
        body2: `您的新密碼是 <b>${params.new_password}</b>`,
        body3: `帳號: <b>${params.account_number}</b>`,
        body4: `的平台: <b>${params.platform}</b><br>伺服器: <b>${params.server}</b><br>`,
        body5: `如果您沒有申請更改密碼，請回復此電子郵件至 <a href="mailto:${params.support_email}">${params.support_email}</a>，以便我們調查原因。`,
        closing: `謹致問候,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  th: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `คำขอให้รีเซ็ตรหัสผ่านบัญชีการเทรดของคุณสำหรับบัญชีเลขที <b>${params.account_number}</b> ดำเนินการสำเร็จแล้ว`,
        body2: `รหัสผ่านใหม่ของคุณคือ <b>${params.new_password}</b>`,
        body3: `เลขที่บัญชี: <b>${params.account_number}</b>`,
        body4: `Platform: <b>${params.platform}</b><br>เซิร์ฟเวอร์: <b>${params.server}</b><br>`,
        body5: `หากคุณไม่ได้ขอให้เปลี่ยนแปลงรหัสผ่าน โปรดตอบกลับอีเมลฉบับนี้เพื่อให้เราสืบสวนสิ่งที่เกิดขึ้น <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `ขอแสดงความนับถือ,<br><br>${params.company_name}`,
      },
      footer: {
  ...
  vi: (params) => {
    ...
    const result = {
      ...
      content: {
        ...
        body1: `Yêu cầu đặt lại mật khẩu tài khoản giao dịch của bạn cho số tài khoản <b>${params.account_number}</b> đã được thực hiện thành công.`,
        body2: `Mật khẩu mới của bạn là <b>${params.new_password}</b>`,
        body3: `Số tài khoản: <b>${params.account_number}</b>`,
        body4: `Nền tảng: <b>${params.platform}</b><br>Máy chủ: <b>${params.server}</b><br>`,
        body5: `Nếu bạn không yêu cầu thay đổi mật khẩu, vui lòng trả lời email này để chúng tôi có thể điều tra sự việc xảy ra <a href="mailto:${params.support_email}">${params.support_email}</a>`,
        closing: `Trân trọng,<br><br>${params.company_name}`,
      },
      footer: {
 ...
 *  transfer_funds_cta: String;
 * }} emailData
 * @returns {{ templateId: String, dynamicTemplateData: Object }}
 */
const createForgotMt5AccountPasswordEmailData = (language, emailData) => {
  const dynamicTemplateData = (
    templateData[language] ? templateData[language] : templateData["en"]
  )(emailData);

  return {
    templateId: "d-5ad060522db04625b36d8e9c12125a42",
    dynamicTemplateData,
  };
};

export default createForgotMt5AccountPasswordEmailData;
