...
const Mt4TradesSchema = new mongoose.Schema({
  // Our own fields
  ...
  sl: Number,
  tp: Number, // stop loss & take profit
  ...
  conv_rates: [Number], // convertation rates from profit currency to group deposit currency
...
Mt4TradesSchema.plugin(paginate);
Mt4TradesSchema.plugin(aggregatePaginate);

export default mongoose.models.Mt4TradesSchema ||
  mongoose.model("Mt4Trades", Mt4TradesSchema);
